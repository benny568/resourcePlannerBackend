...
router.post('/', async (req, res) => {
    try {
        const { title, description, estimateStoryPoints, requiredCompletionDate, requiredSkills, dependencies = [], status = 'Not Started', jiraId, jiraStatus, epicId, isEpic = false, priority = 'Medium' } = req.body;
...
router.put('/:id', async (req, res) => {
    try {
        const { id } = req.params;
        const { title, description, estimateStoryPoints, requiredCompletionDate, requiredSkills, dependencies, status, jiraId, jiraStatus, epicId, isEpic, priority } = req.body;
